...
class userinfo{
    ...
    public void infoprint(int i){
        System.out.println("=======================");
        System.out.println(i+" 번쨰 등록자 님의 ID는 "+this.id+"이고 비밀번호는 "+this.password+"입니다");
        System.out.println(i+" 번쨰 등록자 님의 이름은 "+this.name+"이고 생일은 "+this.birth_date+"입니다");
...
public class UserRegister_add {
    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            register=false;
            while(!register){
                System.out.println(i+" 번쨰 회원가입을 새로 하시겠습니까?\ny:진행    N:취소     I:회원가입 정보 출력");
                System.out.print(">>");
