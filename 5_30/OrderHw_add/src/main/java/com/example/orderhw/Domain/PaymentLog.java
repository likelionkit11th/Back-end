...
//    @Builder.Default()
    ...
    private PaymentLogStatus paymentStatus=PaymentLogStatus.REQUESTED;
    ...
    @Builder
    public PaymentLog(Order order ,PaymentLogTool paymentTool, Long paymentPriceActual, PaymentLogStatus paymentStatus){
        this.orderId=order;
